...
import { INVENTORY_OPS_SERVICE_TOKEN } from '../inventory-operations.service';
  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [
        ...
        { provide: INVENTORY_COUNT_SERVICE_TOKEN, useValue: {} },
        { provide: INVENTORY_OPS_SERVICE_TOKEN, useValue: {} },
      ],
    })
