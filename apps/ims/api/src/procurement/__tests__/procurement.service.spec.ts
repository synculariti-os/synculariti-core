...
import { PURCHASE_ORDER_STATUS } from '@synculariti/types';
...
const mockProcurementRepo: IProcurementRepository = {
  ...
  findPOsByRestaurantId: vi.fn(),
  createVendor: vi.fn(),
  createVendorsBulk: vi.fn(),
  findVendorById: vi.fn(),
  findVendorsByScopedId: vi.fn(),
  updateVendor: vi.fn(),
  findBatchesByRestaurantId: vi.fn(),
  findBatchById: vi.fn(),
  deleteVendor: vi.fn(),
  deleteVendorsBulk: vi.fn(),
};
