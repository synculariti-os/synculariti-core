...
import { InventoryOperationsService, INVENTORY_OPS_SERVICE_TOKEN } from './inventory-operations.service';
...
@Module({
  ...
  providers: [
    ...
    {
      provide: INVENTORY_OPS_SERVICE_TOKEN,
      useClass: InventoryOperationsService,
    },
    {
