...
export type LedgerReasonCode = 'PO_RECEIPT' | 'SALES_DEPLETION' | 'WASTE' | 'TRANSFER_OUT' | 'TRANSFER_IN' | 'COUNT_ADJUSTMENT' | 'PREP_PRODUCTION' | 'PREP_CONSUMPTION' | 'OPENING_BALANCE';
