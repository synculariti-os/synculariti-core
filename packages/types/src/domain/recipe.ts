...
export interface Recipe { id: RecipeId; franchiseGroupId: FranchiseGroupId | null; restaurantId: RestaurantId | null; producesItemId: ItemId | null; recipeName: string | null; producesItemName?: string; yieldQuantity: number; priceEur: number | null; vatRate: number | null; createdAt: string; updatedAt: string; }
