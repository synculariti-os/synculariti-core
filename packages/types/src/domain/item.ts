...
export type ItemType = 'INGREDIENTS' | 'PACKAGING' | 'MERCHANDISE' | 'SUPPLY' | 'MISCELLANEOUS';
...
export interface Category { id: string; franchiseGroupId: FranchiseGroupId | null; restaurantId: RestaurantId | null; name: string; description: string | null; itemType: ItemType | null; categoryGroup: string | null; createdAt: string; updatedAt: string; }
