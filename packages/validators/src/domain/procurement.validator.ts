...
export const poLineItemSchema = z.object({
  ...
  rawUnitPrice: z.number().min(0).optional().default(0),
});
...
export const vendorBulkRowSchema = z.object({
  name: z.string().min(1),
  contactEmail: z.string().email().optional().nullable(),
  isActive: z.boolean().default(true),
});

export const deleteVendorsBulkSchema = z.object({
  ids: z.array(z.string().uuid()).min(1),
});

export type VendorBulkRowDto = z.infer<typeof vendorBulkRowSchema>;

export type CreateVendorDto = z.infer<typeof createVendorSchema>;
export type UpdateVendorDto = z.infer<typeof updateVendorSchema>;
export type DeleteVendorsBulkDto = z.infer<typeof deleteVendorsBulkSchema>;
